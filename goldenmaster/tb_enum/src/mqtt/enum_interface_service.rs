...
impl EnumInterfaceMqttService {
    ...
    pub async fn subscribe_topics(&self) -> Result<(), rumqttc::ClientError> {
        self.client.subscribe(format!("{}/op/func0/req", TOPIC_PREFIX), rumqttc::QoS::AtLeastOnce).await?;
    ...
    fn handle_invoke(
        ...
        match method_name {
            "func0" => {
                ...
                let topic = format!("{}/op/func0/resp", TOPIC_PREFIX);
    ...
    pub async fn publish_prop0_changed(&self) -> Result<(), rumqttc::ClientError> {
