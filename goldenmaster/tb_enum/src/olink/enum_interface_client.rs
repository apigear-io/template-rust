...
impl Default for EnumInterfaceOlinkClient {
    fn default() -> Self {
        Self { data: RwLock::new(EnumInterfaceData::default()), node: RwLock::new(None), publisher: EnumInterfacePublisher::default() }
    }
}

impl EnumInterfaceTrait for EnumInterfaceOlinkClient {
    fn func0(
        &self,
        param0: Enum0Enum,
        ...
        Box::pin(async move {
            if let Some(node) = node {
                ...
                node.invoke_remote(
                    &Name::create_member_id("tb.enum.EnumInterface", "func0"),
                    args,
    ...
    fn func1(
        ...
        Box::pin(async move {
            if let Some(node) = node {
                let (tx, rx) = std::sync::mpsc::sync_channel(1);
                node.invoke_remote(
                    &Name::create_member_id("tb.enum.EnumInterface", "func1"),
                    args,
                    Some(Box::new(move |value| {
                        let _ = tx.send(value);
                    })),
    ...
    fn func2(
        ...
        Box::pin(async move {
            if let Some(node) = node {
                let (tx, rx) = std::sync::mpsc::sync_channel(1);
                node.invoke_remote(
                    &Name::create_member_id("tb.enum.EnumInterface", "func2"),
                    args,
                    Some(Box::new(move |value| {
                        let _ = tx.send(value);
                    })),
    ...
    fn func3(
        ...
        Box::pin(async move {
            if let Some(node) = node {
                let (tx, rx) = std::sync::mpsc::sync_channel(1);
                node.invoke_remote(
                    &Name::create_member_id("tb.enum.EnumInterface", "func3"),
                    args,
                    Some(Box::new(move |value| {
                        let _ = tx.send(value);
                    })),
    ...
    fn set_prop0(
        ...
        if let Some(node) = self.node.read().as_ref() {
            node.set_remote_property(&Name::create_member_id("tb.enum.EnumInterface", "prop0"), json!(prop0));
        }
    }
    ...
    fn set_prop1(
        ...
        if let Some(node) = self.node.read().as_ref() {
            node.set_remote_property(&Name::create_member_id("tb.enum.EnumInterface", "prop1"), json!(prop1));
        }
    }
    ...
    fn set_prop2(
        ...
        if let Some(node) = self.node.read().as_ref() {
            node.set_remote_property(&Name::create_member_id("tb.enum.EnumInterface", "prop2"), json!(prop2));
        }
    }
    ...
    fn set_prop3(
        ...
        if let Some(node) = self.node.read().as_ref() {
            node.set_remote_property(&Name::create_member_id("tb.enum.EnumInterface", "prop3"), json!(prop3));
        }
    }
...
impl ObjectSink for EnumInterfaceOlinkClient {
    ...
    fn olink_on_init(
        ...
        if let Ok(data) = serde_json::from_value::<EnumInterfaceData>(props) {
