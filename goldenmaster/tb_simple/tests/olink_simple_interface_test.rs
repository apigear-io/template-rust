...
use tb_simple::olink::simple_interface_client::SimpleInterfaceOlinkClient;
use tb_simple::olink::simple_interface_service::SimpleInterfaceOlinkService;
...
fn setup_simple_interface() -> (Arc<SimpleInterfaceOlinkClient>, Arc<SimpleInterface>, olink_common::OlinkLoopback) {
    let impl_ = Arc::new(SimpleInterface::default());
    let service: Arc<dyn objectlink_core::traits::ObjectSource> = Arc::new(SimpleInterfaceOlinkService::new(impl_.clone() as Arc<dyn SimpleInterfaceTrait>));
    let loopback = setup_olink_loopback(service);

    let client = Arc::new(SimpleInterfaceOlinkClient::default());
...
mod tests {
    ...
    async fn test_olink_func_no_return_value() {
        let (client, _impl, _loopback) = setup_simple_interface();
    ...
    fn test_olink_set_prop_bool() {
        let (client, impl_, _loopback) = setup_simple_interface();
    ...
    fn test_olink_prop_bool_notify() {
        let (client, _impl, loopback) = setup_simple_interface();
        let rx = client.publisher().prop_bool_changed.subscribe();
        let test_value = json!(true);
        let expected: bool = true;
        loopback.remote_node.notify_property_change("tb.simple.SimpleInterface/propBool", test_value);
    ...
    fn test_olink_prop_int_notify() {
        ...
        loopback.remote_node.notify_property_change("tb.simple.SimpleInterface/propInt", test_value);
    ...
    fn test_olink_prop_int32_notify() {
        ...
        let test_value = json!(1);
        let expected: i32 = 1i32;
        loopback.remote_node.notify_property_change("tb.simple.SimpleInterface/propInt32", test_value);
    ...
    fn test_olink_prop_int64_notify() {
        ...
        let test_value = json!(1);
        let expected: i64 = 1i64;
        loopback.remote_node.notify_property_change("tb.simple.SimpleInterface/propInt64", test_value);
    ...
    fn test_olink_prop_float_notify() {
        ...
        let expected: f32 = 1.0f32;
        loopback.remote_node.notify_property_change("tb.simple.SimpleInterface/propFloat", test_value);
    ...
    fn test_olink_prop_float32_notify() {
        ...
        let test_value = json!(1.0);
        let expected: f32 = 1.0f32;
        loopback.remote_node.notify_property_change("tb.simple.SimpleInterface/propFloat32", test_value);
    ...
    fn test_olink_prop_float64_notify() {
        ...
        let test_value = json!(1.0);
        let expected: f64 = 1.0f64;
        loopback.remote_node.notify_property_change("tb.simple.SimpleInterface/propFloat64", test_value);
    ...
    fn test_olink_prop_string_notify() {
        ...
        loopback.remote_node.notify_property_change("tb.simple.SimpleInterface/propString", test_value);
    ...
    fn test_olink_sig_bool() {
        ...
        loopback.remote_node.notify_signal("tb.simple.SimpleInterface/sigBool", json!([true]));
    ...
    fn test_olink_sig_int() {
        ...
        loopback.remote_node.notify_signal("tb.simple.SimpleInterface/sigInt", json!([1]));
        let received = rx.try_recv().unwrap();
    ...
    fn test_olink_sig_int32() {
        ...
        loopback.remote_node.notify_signal("tb.simple.SimpleInterface/sigInt32", json!([1]));
        let received = rx.try_recv().unwrap();
        assert_eq!(received.0, 1i32);
    }
    ...
    fn test_olink_sig_int64() {
        ...
        loopback.remote_node.notify_signal("tb.simple.SimpleInterface/sigInt64", json!([1]));
        let received = rx.try_recv().unwrap();
        assert_eq!(received.0, 1i64);
    }
    ...
    fn test_olink_sig_float() {
        ...
        loopback.remote_node.notify_signal("tb.simple.SimpleInterface/sigFloat", json!([1.0]));
        let received = rx.try_recv().unwrap();
        assert_eq!(received.0, 1.0f32);
    }
    ...
    fn test_olink_sig_float32() {
        ...
        loopback.remote_node.notify_signal("tb.simple.SimpleInterface/sigFloat32", json!([1.0]));
        let received = rx.try_recv().unwrap();
        assert_eq!(received.0, 1.0f32);
    }
    ...
    fn test_olink_sig_float64() {
        ...
        loopback.remote_node.notify_signal("tb.simple.SimpleInterface/sigFloat64", json!([1.0]));
        let received = rx.try_recv().unwrap();
        assert_eq!(received.0, 1.0f64);
    }
    ...
    fn test_olink_sig_string() {
        ...
        loopback.remote_node.notify_signal("tb.simple.SimpleInterface/sigString", json!(["test"]));
        let received = rx.try_recv().unwrap();
