...
/// MQTT client adapter for NoSignalsInterface.
...
pub struct NoSignalsInterfaceMqttClient {
...
impl NoSignalsInterfaceMqttClient {
    ...
    pub fn new(
        ...
        Self { data: RwLock::new(NoSignalsInterfaceData::default()), client, client_id: client_id.into(), next_correlation: std::sync::atomic::AtomicU64::new(1), pending: Arc::new(Mutex::new(HashMap::new())), publisher: NoSignalsInterfacePublisher::default() }
    }
...
impl NoSignalsInterfaceTrait for NoSignalsInterfaceMqttClient {
