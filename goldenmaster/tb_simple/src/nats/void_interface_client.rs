...
impl VoidInterfaceNatsClient {
    ...
    fn handle_state(
        ...
        if let Ok(data) = serde_json::from_slice::<VoidInterfaceData>(&msg.payload) {
            *self.data.write() = data;
        }
    }
}

impl VoidInterfaceTrait for VoidInterfaceNatsClient {
