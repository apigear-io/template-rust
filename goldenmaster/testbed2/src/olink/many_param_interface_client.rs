...
impl Default for ManyParamInterfaceOlinkClient {
    fn default() -> Self {
        Self { data: RwLock::new(ManyParamInterfaceData::default()), node: RwLock::new(None), publisher: ManyParamInterfacePublisher::default() }
    }
}

impl ManyParamInterfaceTrait for ManyParamInterfaceOlinkClient {
    fn func1(
        &self,
        param1: i32,
        ...
        Box::pin(async move {
            if let Some(node) = node {
                ...
                node.invoke_remote(
                    &Name::create_member_id("testbed2.ManyParamInterface", "func1"),
                    args,
    ...
    fn func2(
        ...
        Box::pin(async move {
            if let Some(node) = node {
                let (tx, rx) = std::sync::mpsc::sync_channel(1);
                node.invoke_remote(
                    &Name::create_member_id("testbed2.ManyParamInterface", "func2"),
                    args,
                    Some(Box::new(move |value| {
                        let _ = tx.send(value);
                    })),
    ...
    fn func3(
        ...
        Box::pin(async move {
            if let Some(node) = node {
                let (tx, rx) = std::sync::mpsc::sync_channel(1);
                node.invoke_remote(
                    &Name::create_member_id("testbed2.ManyParamInterface", "func3"),
                    args,
                    Some(Box::new(move |value| {
                        let _ = tx.send(value);
                    })),
    ...
    fn func4(
        ...
        Box::pin(async move {
            if let Some(node) = node {
                let (tx, rx) = std::sync::mpsc::sync_channel(1);
                node.invoke_remote(
                    &Name::create_member_id("testbed2.ManyParamInterface", "func4"),
                    args,
                    Some(Box::new(move |value| {
                        let _ = tx.send(value);
                    })),
    ...
    fn set_prop1(
        ...
        if let Some(node) = self.node.read().as_ref() {
            node.set_remote_property(&Name::create_member_id("testbed2.ManyParamInterface", "prop1"), json!(prop1));
        }
    }
    ...
    fn set_prop2(
        ...
        if let Some(node) = self.node.read().as_ref() {
            node.set_remote_property(&Name::create_member_id("testbed2.ManyParamInterface", "prop2"), json!(prop2));
        }
    }
    ...
    fn set_prop3(
        ...
        if let Some(node) = self.node.read().as_ref() {
            node.set_remote_property(&Name::create_member_id("testbed2.ManyParamInterface", "prop3"), json!(prop3));
        }
    }
    ...
    fn set_prop4(
        ...
        if let Some(node) = self.node.read().as_ref() {
            node.set_remote_property(&Name::create_member_id("testbed2.ManyParamInterface", "prop4"), json!(prop4));
        }
    }
...
impl ObjectSink for ManyParamInterfaceOlinkClient {
    ...
    fn olink_on_init(
        ...
        if let Ok(data) = serde_json::from_value::<ManyParamInterfaceData>(props) {
