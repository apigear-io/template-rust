...
impl ManyParamInterfaceMqttService {
    ...
    pub async fn subscribe_topics(&self) -> Result<(), rumqttc::v5::ClientError> {
        ...
        self.client.subscribe(format!("{}/rpc/func4", TOPIC_PREFIX), QoS::AtLeastOnce).await?;
        ...
        self.client.subscribe(format!("{}/set/prop4", TOPIC_PREFIX), QoS::AtLeastOnce).await?;
        Ok(())
    }
    ...
    pub async fn publish_prop4_changed(&self) -> Result<(), rumqttc::v5::ClientError> {
    ...
    pub async fn publish_current_state(&self) -> Result<(), rumqttc::v5::ClientError> {
        ...
        self.publish_prop4_changed().await?;
        Ok(())
    }
}
