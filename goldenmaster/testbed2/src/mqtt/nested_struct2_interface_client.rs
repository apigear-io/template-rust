...
const TOPIC_PREFIX: &str = "testbed2/NestedStruct2Interface";
const RPC_TIMEOUT: Duration = Duration::from_secs(5);

/// MQTT client adapter for NestedStruct2Interface.
...
pub struct NestedStruct2InterfaceMqttClient {
...
impl NestedStruct2InterfaceMqttClient {
    ...
    pub fn new(
        ...
        Self { data: RwLock::new(NestedStruct2InterfaceData::default()), client, client_id: client_id.into(), next_correlation: std::sync::atomic::AtomicU64::new(1), pending: Arc::new(Mutex::new(HashMap::new())), publisher: NestedStruct2InterfacePublisher::default() }
    }
...
impl NestedStruct2InterfaceTrait for NestedStruct2InterfaceMqttClient {
    fn func1(
        &self,
