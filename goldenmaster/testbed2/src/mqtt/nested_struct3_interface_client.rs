...
impl NestedStruct3InterfaceMqttClient {
    ...
    pub fn new(
        ...
        Self { data: RwLock::new(NestedStruct3InterfaceData::default()), client, client_id: client_id.into(), next_correlation: std::sync::atomic::AtomicU64::new(1), pending: Arc::new(Mutex::new(HashMap::new())), publisher: NestedStruct3InterfacePublisher::default() }
    }
