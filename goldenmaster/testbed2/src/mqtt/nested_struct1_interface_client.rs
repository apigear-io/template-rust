...
/// MQTT client adapter for NestedStruct1Interface.
...
pub struct NestedStruct1InterfaceMqttClient {
...
impl NestedStruct1InterfaceMqttClient {
    ...
    pub fn new(
        ...
        Self { data: RwLock::new(NestedStruct1InterfaceData::default()), client, client_id: client_id.into(), next_correlation: std::sync::atomic::AtomicU64::new(1), pending: Arc::new(Mutex::new(HashMap::new())), publisher: NestedStruct1InterfacePublisher::default() }
    }
...
impl NestedStruct1InterfaceTrait for NestedStruct1InterfaceMqttClient {
