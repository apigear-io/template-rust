...
const TOPIC_PREFIX: &str = "apigear.testbed2.NestedStruct1Interface";
...
impl NestedStruct1InterfaceNatsClient {
    pub fn new(client: async_nats::Client) -> Self {
        Self { data: RwLock::new(NestedStruct1InterfaceData::default()), client, publisher: NestedStruct1InterfacePublisher::default() }
    }
