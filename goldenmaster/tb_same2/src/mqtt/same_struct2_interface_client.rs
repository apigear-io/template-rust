...
const TOPIC_PREFIX: &str = "tb.same2/SameStruct2Interface";
...
impl SameStruct2InterfaceMqttClient {
    ...
    pub fn new(
        ...
        Self { data: RwLock::new(SameStruct2InterfaceData::default()), client, client_id: client_id.into(), next_correlation: std::sync::atomic::AtomicU64::new(1), pending: Arc::new(Mutex::new(HashMap::new())), publisher: SameStruct2InterfacePublisher::default() }
    }
