...
/// OLink service adapter for SameEnum1Interface.
/// Bridges a local implementation to the OLink protocol by implementing ObjectSource.
pub struct SameEnum1InterfaceOlinkService {
    impl_: Arc<dyn SameEnum1InterfaceTrait>,
}

impl SameEnum1InterfaceOlinkService {
    pub fn new(impl_: Arc<dyn SameEnum1InterfaceTrait>) -> Self {
        Self { impl_ }
    }
}

impl ObjectSource for SameEnum1InterfaceOlinkService {
    ...
    fn olink_linked(
        ...
        tracing::info!("SameEnum1Interface linked");
    }
    ...
    fn olink_unlinked(
        ...
        tracing::info!("SameEnum1Interface unlinked");
    }
