...
/// OLink service adapter for SameStruct1Interface.
/// Bridges a local implementation to the OLink protocol by implementing ObjectSource.
pub struct SameStruct1InterfaceOlinkService {
    impl_: Arc<dyn SameStruct1InterfaceTrait>,
}

impl SameStruct1InterfaceOlinkService {
    pub fn new(impl_: Arc<dyn SameStruct1InterfaceTrait>) -> Self {
        Self { impl_ }
    }
}

impl ObjectSource for SameStruct1InterfaceOlinkService {
    ...
    fn olink_linked(
        ...
        tracing::info!("SameStruct1Interface linked");
    }
    ...
    fn olink_unlinked(
        ...
        tracing::info!("SameStruct1Interface unlinked");
    }
