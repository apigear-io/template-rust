...
use tb_same2::nats::same_struct2_interface_client::SameStruct2InterfaceNatsClient;
use tb_same2::nats::same_struct2_interface_service::SameStruct2InterfaceNatsService;
use std::sync::Arc;
