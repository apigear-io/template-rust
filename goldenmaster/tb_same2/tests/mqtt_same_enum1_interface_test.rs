...
use tb_same2::mqtt::same_enum1_interface_client::SameEnum1InterfaceMqttClient;
use tb_same2::mqtt::same_enum1_interface_service::SameEnum1InterfaceMqttService;
use std::sync::Arc;
...
async fn test_mqtt_same_enum1_interface_roundtrip() {
    ...
    let (service_client, service_loop) = mqtt_common::connect("svc-tb_same2-same_enum1_interface");
    ...
    let (client_client, client_loop) = mqtt_common::connect("cli-tb_same2-same_enum1_interface");
    let client = Arc::new(SameEnum1InterfaceMqttClient::new(client_client, "cli-tb_same2-same_enum1_interface"));
