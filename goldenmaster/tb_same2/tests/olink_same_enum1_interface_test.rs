...
use tb_same2::olink::same_enum1_interface_client::SameEnum1InterfaceOlinkClient;
use tb_same2::olink::same_enum1_interface_service::SameEnum1InterfaceOlinkService;
...
mod tests {
    ...
    fn test_olink_prop1_notify() {
        ...
        loopback.remote_node.notify_property_change("tb.same2.SameEnum1Interface/prop1", test_value);
    ...
    fn test_olink_sig1() {
        ...
        loopback.remote_node.notify_signal("tb.same2.SameEnum1Interface/sig1", json!([null]));
