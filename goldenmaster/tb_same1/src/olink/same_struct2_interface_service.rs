...
/// OLink service adapter for SameStruct2Interface.
/// Bridges a local implementation to the OLink protocol by implementing ObjectSource.
pub struct SameStruct2InterfaceOlinkService {
    impl_: Arc<dyn SameStruct2InterfaceTrait>,
}

impl SameStruct2InterfaceOlinkService {
    pub fn new(impl_: Arc<dyn SameStruct2InterfaceTrait>) -> Self {
        Self { impl_ }
    }
}

impl ObjectSource for SameStruct2InterfaceOlinkService {
    ...
    fn olink_linked(
        ...
        tracing::info!("SameStruct2Interface linked");
    }
    ...
    fn olink_unlinked(
        ...
        tracing::info!("SameStruct2Interface unlinked");
    }
