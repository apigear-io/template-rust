...
const TOPIC_PREFIX: &str = "tb.same1.SameStruct1Interface";
...
/// NATS client adapter for SameStruct1Interface.
...
pub struct SameStruct1InterfaceNatsClient {
...
impl SameStruct1InterfaceNatsClient {
    pub fn new(client: async_nats::Client) -> Self {
        Self { data: RwLock::new(SameStruct1InterfaceData::default()), client, client_id: new_client_id(), publisher: SameStruct1InterfacePublisher::default() }
    }
    ...
    fn handle_property_change(
        ...
        match member {
            "prop1" => {
                if let Ok(v) = serde_json::from_value::<Struct1>(payload) {
    ...
    fn handle_state(
        ...
        if let Ok(data) = serde_json::from_slice::<SameStruct1InterfaceData>(&msg.payload) {
            *self.data.write() = data;
        }
    }
}

impl SameStruct1InterfaceTrait for SameStruct1InterfaceNatsClient {
    fn func1(
        &self,
        param1: &Struct1,
