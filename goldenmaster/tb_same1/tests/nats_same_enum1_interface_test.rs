...
use tb_same1::nats::same_enum1_interface_client::SameEnum1InterfaceNatsClient;
use tb_same1::nats::same_enum1_interface_service::SameEnum1InterfaceNatsService;
use std::sync::Arc;
