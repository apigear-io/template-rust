...
use tb_same1::olink::same_struct1_interface_client::SameStruct1InterfaceOlinkClient;
use tb_same1::olink::same_struct1_interface_service::SameStruct1InterfaceOlinkService;
...
mod tests {
    ...
    fn test_olink_prop1_notify() {
        ...
        loopback.remote_node.notify_property_change("tb.same1.SameStruct1Interface/prop1", test_value);
    ...
    fn test_olink_sig1() {
        ...
        loopback.remote_node.notify_signal("tb.same1.SameStruct1Interface/sig1", json!([null]));
