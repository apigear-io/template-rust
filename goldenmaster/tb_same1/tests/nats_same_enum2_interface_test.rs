...
use tb_same1::nats::same_enum2_interface_client::SameEnum2InterfaceNatsClient;
use tb_same1::nats::same_enum2_interface_service::SameEnum2InterfaceNatsService;
use std::sync::Arc;
