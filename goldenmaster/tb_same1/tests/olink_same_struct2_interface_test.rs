...
use tb_same1::olink::same_struct2_interface_client::SameStruct2InterfaceOlinkClient;
use tb_same1::olink::same_struct2_interface_service::SameStruct2InterfaceOlinkService;
...
mod tests {
    ...
    fn test_olink_prop1_notify() {
        ...
        loopback.remote_node.notify_property_change("tb.same1.SameStruct2Interface/prop1", test_value);
    ...
    fn test_olink_prop2_notify() {
        ...
        let expected: Struct2 = Default::default();
        let test_value = serde_json::to_value(&expected).unwrap();
        loopback.remote_node.notify_property_change("tb.same1.SameStruct2Interface/prop2", test_value);
    ...
    fn test_olink_sig1() {
        ...
        loopback.remote_node.notify_signal("tb.same1.SameStruct2Interface/sig1", json!([null]));
    ...
    fn test_olink_sig2() {
        ...
        loopback.remote_node.notify_signal("tb.same1.SameStruct2Interface/sig2", json!([null, null]));
        let received = rx.try_recv().unwrap();
        let _signal_param_0 = received.0.clone();
