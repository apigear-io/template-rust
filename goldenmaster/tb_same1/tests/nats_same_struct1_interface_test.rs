...
use tb_same1::nats::same_struct1_interface_client::SameStruct1InterfaceNatsClient;
use tb_same1::nats::same_struct1_interface_service::SameStruct1InterfaceNatsService;
use std::sync::Arc;
