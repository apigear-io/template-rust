...
use tb_same1::mqtt::same_struct2_interface_client::SameStruct2InterfaceMqttClient;
use tb_same1::mqtt::same_struct2_interface_service::SameStruct2InterfaceMqttService;
use std::sync::Arc;
...
async fn test_mqtt_same_struct2_interface_roundtrip() {
    ...
    let (service_client, service_loop) = mqtt_common::connect("svc-tb_same1-same_struct2_interface");
    ...
    let (client_client, client_loop) = mqtt_common::connect("cli-tb_same1-same_struct2_interface");
    let client = Arc::new(SameStruct2InterfaceMqttClient::new(client_client, "cli-tb_same1-same_struct2_interface"));
