...
mod tests {
    ...
    fn test_prop_bool() {
        let test_object = StructArray2Interface::default();
        let default_value: StructBoolWithArray = Default::default();
    ...
    fn test_prop_int() {
        let test_object = StructArray2Interface::default();
        let default_value: StructIntWithArray = Default::default();
    ...
    fn test_prop_float() {
        let test_object = StructArray2Interface::default();
        let default_value: StructFloatWithArray = Default::default();
    ...
    fn test_prop_string() {
        let test_object = StructArray2Interface::default();
        let default_value: StructStringWithArray = Default::default();
    ...
    fn test_prop_enum() {
        let test_object = StructArray2Interface::default();
        let default_value: StructEnumWithArray = Default::default();
        test_object.set_prop_enum(&default_value.clone());
    ...
    fn test_sig_bool() {
        ...
        let default_value_param_bool: StructBoolWithArray = Default::default();
    ...
    fn test_sig_int() {
        ...
        let default_value_param_int: StructIntWithArray = Default::default();
    ...
    fn test_sig_float() {
        ...
        let default_value_param_float: StructFloatWithArray = Default::default();
    ...
    fn test_sig_string() {
        ...
        let default_value_param_string: StructStringWithArray = Default::default();
