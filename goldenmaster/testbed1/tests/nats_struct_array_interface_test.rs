...
use testbed1::nats::struct_array_interface_client::StructArrayInterfaceNatsClient;
use testbed1::nats::struct_array_interface_service::StructArrayInterfaceNatsService;
use std::sync::Arc;
...
async fn test_nats_struct_array_interface_roundtrip() {
