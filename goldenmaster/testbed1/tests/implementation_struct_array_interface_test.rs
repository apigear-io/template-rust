...
mod tests {
    ...
    async fn test_func_bool() {
        let test_object = StructArrayInterface::default();
    ...
    fn test_prop_enum() {
        let test_object = StructArrayInterface::default();
        let default_value: Vec<Enum0Enum> = Default::default();
        test_object.set_prop_enum(default_value.as_slice());
        assert_eq!(test_object.prop_enum(), default_value);
    }
    ...
    fn test_sig_bool() {
        ...
        let default_value_param_bool: Vec<StructBool> = Default::default();
    ...
    fn test_sig_int() {
        ...
        let default_value_param_int: Vec<StructInt> = Default::default();
    ...
    fn test_sig_float() {
        ...
        let default_value_param_float: Vec<StructFloat> = Default::default();
    ...
    fn test_sig_string() {
        ...
        let default_value_param_string: Vec<StructString> = Default::default();
    ...
    fn test_sig_enum() {
        let test_object = StructArrayInterface::default();
        let mut rx = test_object.publisher().sig_enum.subscribe();
        let default_value_param_enum: Vec<Enum0Enum> = Default::default();
        let _ = test_object.publisher().sig_enum.send((default_value_param_enum.clone(),));
        let received = rx.try_recv().unwrap();
        assert_eq!(received.0, default_value_param_enum);
    }
}
