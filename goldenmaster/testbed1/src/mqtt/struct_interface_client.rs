...
impl StructInterfaceMqttClient {
    ...
    pub fn new(
        ...
        Self { data: RwLock::new(StructInterfaceData::default()), client, client_id: client_id.into(), next_correlation: std::sync::atomic::AtomicU64::new(1), pending: Arc::new(Mutex::new(HashMap::new())), publisher: StructInterfacePublisher::default() }
    }
