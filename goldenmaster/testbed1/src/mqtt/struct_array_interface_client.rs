...
/// MQTT client adapter for StructArrayInterface.
...
pub struct StructArrayInterfaceMqttClient {
...
impl StructArrayInterfaceMqttClient {
    ...
    pub fn new(
        ...
        Self { data: RwLock::new(StructArrayInterfaceData::default()), client, client_id: client_id.into(), next_correlation: std::sync::atomic::AtomicU64::new(1), pending: Arc::new(Mutex::new(HashMap::new())), publisher: StructArrayInterfacePublisher::default() }
    }
    ...
    pub async fn subscribe_topics(&self) -> Result<(), rumqttc::v5::ClientError> {
        ...
        self.client.subscribe(format!("{}/sig/sigEnum", TOPIC_PREFIX), QoS::AtLeastOnce).await?;
...
impl StructArrayInterfaceTrait for StructArrayInterfaceMqttClient {
    fn func_bool(
        &self,
