...
impl StructArrayInterfaceMqttClient {
    ...
    pub async fn subscribe_topics(&self) -> Result<(), rumqttc::ClientError> {
        ...
        self.client.subscribe(format!("{}/sig/sigEnum", TOPIC_PREFIX), rumqttc::QoS::AtLeastOnce).await?;
    ...
    fn handle_state(
        ...
        if let Ok(data) = serde_json::from_value::<StructArrayInterfaceData>(value) {
