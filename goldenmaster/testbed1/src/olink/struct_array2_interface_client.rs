...
impl Default for StructArray2InterfaceOlinkClient {
    fn default() -> Self {
        Self { data: RwLock::new(StructArray2InterfaceData::default()), node: RwLock::new(None), publisher: StructArray2InterfacePublisher::default() }
    }
}

impl StructArray2InterfaceTrait for StructArray2InterfaceOlinkClient {
    fn func_bool(
        &self,
        ...
        Box::pin(async move {
            if let Some(node) = node {
                ...
                node.invoke_remote(
                    &Name::create_member_id("testbed1.StructArray2Interface", "funcBool"),
                    args,
    ...
    fn func_int(
        ...
        Box::pin(async move {
            if let Some(node) = node {
                let (tx, rx) = std::sync::mpsc::sync_channel(1);
                node.invoke_remote(
                    &Name::create_member_id("testbed1.StructArray2Interface", "funcInt"),
                    args,
                    Some(Box::new(move |value| {
                        let _ = tx.send(value);
                    })),
    ...
    fn func_float(
        ...
        Box::pin(async move {
            if let Some(node) = node {
                let (tx, rx) = std::sync::mpsc::sync_channel(1);
                node.invoke_remote(
                    &Name::create_member_id("testbed1.StructArray2Interface", "funcFloat"),
                    args,
                    Some(Box::new(move |value| {
                        let _ = tx.send(value);
                    })),
    ...
    fn func_string(
        ...
        Box::pin(async move {
            if let Some(node) = node {
                let (tx, rx) = std::sync::mpsc::sync_channel(1);
                node.invoke_remote(
                    &Name::create_member_id("testbed1.StructArray2Interface", "funcString"),
                    args,
                    Some(Box::new(move |value| {
                        let _ = tx.send(value);
                    })),
    ...
    fn func_enum(
        ...
        Box::pin(async move {
            if let Some(node) = node {
                let (tx, rx) = std::sync::mpsc::sync_channel(1);
                node.invoke_remote(
                    &Name::create_member_id("testbed1.StructArray2Interface", "funcEnum"),
                    args,
                    Some(Box::new(move |value| {
                        let _ = tx.send(value);
                    })),
    ...
    fn set_prop_bool(
        ...
        if let Some(node) = self.node.read().as_ref() {
            node.set_remote_property(&Name::create_member_id("testbed1.StructArray2Interface", "propBool"), json!(prop_bool));
        }
    }
    ...
    fn set_prop_int(
        ...
        if let Some(node) = self.node.read().as_ref() {
            node.set_remote_property(&Name::create_member_id("testbed1.StructArray2Interface", "propInt"), json!(prop_int));
        }
    }
    ...
    fn set_prop_float(
        ...
        if let Some(node) = self.node.read().as_ref() {
            node.set_remote_property(&Name::create_member_id("testbed1.StructArray2Interface", "propFloat"), json!(prop_float));
        }
    }
    ...
    fn set_prop_string(
        ...
        if let Some(node) = self.node.read().as_ref() {
            node.set_remote_property(&Name::create_member_id("testbed1.StructArray2Interface", "propString"), json!(prop_string));
        }
    }
    ...
    fn set_prop_enum(
        ...
        if let Some(node) = self.node.read().as_ref() {
            node.set_remote_property(&Name::create_member_id("testbed1.StructArray2Interface", "propEnum"), json!(prop_enum));
        }
    }
...
impl ObjectSink for StructArray2InterfaceOlinkClient {
    ...
    fn olink_on_init(
        ...
        if let Ok(data) = serde_json::from_value::<StructArray2InterfaceData>(props) {
